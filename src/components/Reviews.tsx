...
export default function Reviews() {
  ...
  const handleDelete = (id: string) => {
    if (confirm(t('delete_confirm', 'reviews'))) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-slate-100">
            ...
            <div className="flex items-center gap-4 pb-4 md:pb-0 md:pr-6">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">{t('stat_rating', 'reviews')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 py-4 md:py-0 md:px-6">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">{t('stat_hygiene', 'reviews')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 md:pt-0 md:pl-6">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded-full font-black uppercase">{t('stat_satisfied', 'reviews')}</span>
                </div>
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">{t('stat_tx', 'reviews')}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
            ...
            <div className="space-y-3 text-center md:text-left">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-[10px] font-black uppercase tracking-widest">
                ...
                {t('quote_badge', 'reviews')}
              </div>
              
              <h3 className="text-base font-black text-slate-900 uppercase tracking-tight">
                {t('quote_title', 'reviews')}
              </h3>
              
              <p className="text-slate-700 font-semibold text-sm leading-relaxed max-w-4xl" dangerouslySetInnerHTML={{ __html: t('quote_text', 'reviews') }} />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-10 space-y-4">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative w-full md:w-72">
              <input
                type="text"
                placeholder={t('search_placeholder', 'reviews')}
                value={searchQuery}
                  ...
                  <div className="border-t border-slate-100 pt-6 mt-auto">
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                        {t('card_product', 'reviews')} <span className="text-slate-900">{review.productName}</span>
                      </span>
        ...
        {filteredReviews.length === 0 && (
          <div className="text-center py-20 bg-white rounded-3xl border-2 border-slate-200 max-w-lg mx-auto shadow-sm">
            ...
            <h4 className="font-black text-slate-700 uppercase tracking-wider text-sm">{t('empty_title', 'reviews')}</h4>
            <p className="text-xs text-slate-400 font-medium max-w-xs mx-auto mt-2 leading-relaxed">
              {t('empty_desc', 'reviews').replace('{searchQuery}', searchQuery)}
            </p>
          </div>
        )}
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider">{t('trust_c1_title', 'reviews')}</h4>
                  </div>
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                    {t('trust_c1_desc', 'reviews')}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider">{t('trust_c2_title', 'reviews')}</h4>
                  </div>
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                    {t('trust_c2_desc', 'reviews')}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider">{t('trust_c3_title', 'reviews')}</h4>
                  </div>
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                    {t('trust_c3_desc', 'reviews')}
                  </p>
                </div>
              </div>
            </div>
